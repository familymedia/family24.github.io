document.addEventListener('DOMContentLoaded', function () {
    const rssUrls = [
        { url: 'https://feeds.elpais.com/mrss-s/pages/ep/site/elpais.com/section/deportes/portada', source: 'El Pa\u00eds', numNews: 30 },
        { url: 'https://www.abc.es/rss/feeds/abc_Deportes.xml', source: 'ABC', numNews: 30 },
        { url: 'https://e00-elmundo.uecdn.es/elmundodeporte/rss/portada.xml', source: 'El Mundo', numNews: 30 },
        { url: 'https://www.lavanguardia.com/rss/deportes.xml', source: 'La Vanguardia', numNews: 30 },
        { url: 'https://www.levante-emv.com/rss/section/4645', source: 'Levante EMV', numNews: 30 },
        { url: 'https://www.20minutos.es/rss/deportes/', source: '20 Minutos', numNews: 30 },
    ];
